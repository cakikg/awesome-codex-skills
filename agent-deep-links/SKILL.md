...
- When a line number is not known, omit the `:<line>:<column>` suffix rather than defaulting to `:0:0`.
...
- Windsurf file (personal note: confirmed working on macOS as of 2025-06):
