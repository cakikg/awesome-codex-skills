...
> **Personal note:** I keep my skills in `~/projects/codex-skills/` and symlink that directory to `~/.codex/skills/` so I can version-control my local additions separately from this repo.
